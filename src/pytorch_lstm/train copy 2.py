...
try:
    ...
    from src.pytorch_lstm.helpers import check_rate_word, clean_text, text_to_index
    from src.pytorch_lstm.module import Decoder, Encoder, Seq2Seq

except ImportError:
    from helpers import add_path_init, check_rate_word, clean_text, text_to_index
...
def main():
    ...
    x_tokenizer = text_to_index(x_tr, STOPWORDS_USE)
    ...
    y_tokenizer = text_to_index(y_tr, STOPWORDS_USE)
