...
data_summary = pd.read_csv("./datasets/data_csv_xlsx/data_summary.csv")
...
for journal_id in data_summary["Journal_ID"]:
    data_text = pd.read_csv(f"./datasets/data_text/{journal_id}.csv")
...
data_summary.to_csv('./datasets/data_full.csv', encoding="utf-8")
data_summary.to_excel('./datasets/data_full.xlsx')
